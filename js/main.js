...
var _hashy = require('hashy');

var _hashy2 = _interopRequireDefault(_hashy);
...
},{"hashy":3,"jquery":2}],2:[function(require,module,exports){
/*!
...
;var __browserify_shim_require__ = require;(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
  ...
  (function () {
    ...
    var hashy = function hashy(options) {
      var _this = this;
      ...
      hashy.checkElem = function () {

        var scrollPos = function scrollPos() {
          var _getPosition;

          _getPosition = function getPosition() {
            ...
            elemArray.forEach(function (elem) {
              ...
              if (hashy.ScrollOffset + height > elemOffset && hashy.ScrollOffset > elemOffset && hashy.ScrollOffset < elemOffset + elemHeight) {
                if (elem !== hashy.SelectedElem) {
                  ...
                  hashy.setHash(hashy.SelectedElem.getAttribute(_this.itemAttr), true);
                };
              }
            });

            hashy.runtime = requestAnimationFrame(_getPosition);
          };
      ...
      hashy.bind = function (elems) {
        for (var i = 0; i < elems.length; i++) {
          var elem = elems[i];
          if (_this.triggerAttr) {
            var attr = _this.triggerAttr;
          } else {
            var attr = href;
          }
      ...
      hashy.setHash = function (hash, history, callback) {
      ...
      hashy.go = function (hash, history) {
        var elem = document.querySelector('[' + _this.itemAttr + '="' + hash + '"]');
        hashy.scrollTo(elem, hash, function () {
          hashy.setHash(hash, history, function () {
            hashy.checkElem();
          });
        });
      };

      hashy.checkOffset = function (offset) {
      ...
      hashy.getHeight = function (className) {
      ...
      hashy.scrollTo = function (elem, hash, callback) {
        ...
        if (elemPos > hashy.ScrollOffset) {
          ...
          var y = elemPos;
          var diff = y - i;
          var scrollPlus = function scrollPlus() {
            if (i < y) {
              i = i + diff / _this.averageSpeed;
          ...
          var y = elemPos;
          var diff = i - y;
          var scrollMinus = function scrollMinus() {
            if (i > y) {
              i = i - diff / _this.averageSpeed;
              document.body.scrollTop = i;
              document.documentElement.scrollTop = i;
      ...
      var resizeTimeout;
      hashy.doneResize = function () {
        hashy.GlobalOffset = hashy.checkOffset(_this.offset);
      ...
      if (window.location.hash.length && window.location.hash != 'undefined') {
        ...
        var elem = document.querySelector('[' + this.itemAttr + '="' + cleanHash + '"]');
  ...
  ;browserify_shim__define__module__export__(typeof hashy != "undefined" ? hashy : window.hashy);
