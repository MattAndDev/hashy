  ...
  (function () {
    ...
    var hashy = function hashy(options) {
      ...
      hashy.checkElem = function () {
        ...
        var scrollPos = function scrollPos() {
          ...
          _getPosition = function getPosition() {
            ...
            if (_this.scrollOffset === undefined) {
      ...
      hashy.scrollTo = function (elem, hash) {
        ...
        if (typeof _this.offset == 'string') {
          var offset = hashy.getHeight(_this.offset) * -1;
        } else {
          var offset = _this.offset * -1;
        }
        var elemPos = Math.abs(elem.offsetTop) + 1 + offset;
